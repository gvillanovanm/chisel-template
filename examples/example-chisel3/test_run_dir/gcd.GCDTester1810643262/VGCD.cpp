...
VL_INLINE_OPT void VGCD::_sequent__TOP__1(VGCD__Syms* __restrict vlSymsp) {
    ...
    VGCD* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /home/gvillanova/Engineering/developer/hw/systemverilog/workspace/rocket-chip/chisel/template-1/test_run_dir/gcd.GCDTester1810643262/GCD.v:69
    if (vlTOPp->io_loadingValues) {
	vlTOPp->GCD__DOT__x = vlTOPp->io_value1;
    } else {
	if (vlTOPp->GCD__DOT___T_9) {
	    vlTOPp->GCD__DOT__x = (0xffffU & vlTOPp->GCD__DOT___T_10);
	}
    }
    if (vlTOPp->io_loadingValues) {
	vlTOPp->GCD__DOT__y = vlTOPp->io_value2;
    } else {
	if ((1U & (~ (IData)(vlTOPp->GCD__DOT___T_9)))) {
	    vlTOPp->GCD__DOT__y = (0xffffU & vlTOPp->GCD__DOT___T_13);
	}
    }
    vlTOPp->io_outputGCD = vlTOPp->GCD__DOT__x;
    vlTOPp->io_outputValid = (0U == (IData)(vlTOPp->GCD__DOT__y));
    vlTOPp->GCD__DOT___T_9 = ((IData)(vlTOPp->GCD__DOT__x) 
			      > (IData)(vlTOPp->GCD__DOT__y));
    vlTOPp->GCD__DOT___T_10 = (0x1ffffU & ((IData)(vlTOPp->GCD__DOT__x) 
					   - (IData)(vlTOPp->GCD__DOT__y)));
    vlTOPp->GCD__DOT___T_13 = (0x1ffffU & ((IData)(vlTOPp->GCD__DOT__y) 
...
void VGCD::_ctor_var_reset() {
    ...
    GCD__DOT___T_9 = VL_RAND_RESET_I(1);
    GCD__DOT___T_10 = VL_RAND_RESET_I(17);
    GCD__DOT___T_13 = VL_RAND_RESET_I(17);
